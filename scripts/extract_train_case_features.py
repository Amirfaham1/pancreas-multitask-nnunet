...
def _schema_sha256(names_by_view: dict[str, tuple[str, ...]]) -> str:
...
def _load_case_cache(
    ...
    *,
    ...
    with np.load(path, allow_pickle=False) as payload:
        ...
        if (
            mil["mil_stage3_maps"].ndim != 5
            or mil["mil_prediction_maps"].shape[0] != mil["mil_stage3_maps"].shape[0]
...
def run(args: argparse.Namespace) -> Path:
        ...
        if cache_path.is_file() and args.resume:
            ...
            if feature_names is None:
                ...
                schema_payload = {
                    ...
                    "feature_schema_sha256": _schema_sha256(current_names),
        ...
        source_manifest.append(
            {
                "case_id": case.case_id,
                "label": case.label,
                "image_sha256": file_sha256(case.image_path),
            }
        )
    ...
    audit = {
        ...
        "feature_lock_sha256": file_sha256(lock_path),
        "feature_schema_sha256": _schema_sha256(feature_names),
        "identifier_independent_dataset_sha256": (
